...
(6, 'Nikon,Z6 Mirrorless Camera with NIKKOR Z 24-70mm Lens Kit', 3399, 'If you thrive on adaptability, the Nikon Z6 is the mirrorless camera for you. It delivers a combination of impeccable speed, resolution, and low-light performance. Pair these benefits with the portable advantages of a lightweight mirrorless design, and you\'re ready to capture stunning images anywhere you roam.', 2),
(7, 'Dell,G5 Gaming PC - Abyss Grey (Intel Core i7 9700/512GB SSD/16GB RAM/GeForce RTX 2060)', 1699, 'The Dell G5 PC is designed for intense gamers. Its Intel Core i7 9700 processor and 16GB DDR4 RAM combine to deliver exceptional performance to smoothly run advanced games and handle multi-tasking. The 512GB of solid-state drive capacity provides enough space to store games, document, media files and much more.', 3),
(8, 'ASUS,VivoBook L203NA 11.6 Laptop (Intel Dual-Core Celeron N3350/64GB eMMC/4GB RAM/Windows 10 S)', 249, 'Stay productive and entertained with the ASUS VivoBook 11.6 L203NA laptop. Featuring the powerful Intel Celeron N3350 processor and 4GB LPDDR3 RAM, this laptop allows you to work on multiple apps or softwares simultaneously without any lag. Its 64GB eMMC let you store your valuable project files and other important data.', 3),
(9, 'HP,15.6 Gaming Laptop (AMD Ryzen 5 4600H/256GB SSD/8GB RAM/NVIDIA GeForce GTX 1050/Win 10)', 829, 'Get immersed in mind-blowing action with the HP 15.6 Gaming Laptop. Overclockable AMD Ryzen 5 4600H processor and 8GB DDR4-3200 SDRAM provide the power to handle performance-demanding games and applications. Built for prolonged gaming sessions, it is designed with dual fan system, rear vents, and enlarged air inlets for proper airflow.', 3),
(10, 'Samsung,65 4K UHD HDR LED Tizen Smart TV (UN65TU8500FXZC)', 1199, 'Take your entertainment to the next level with the Samsung 65 4K UHD LED Tizen smart TV. Powered by an ultra-fast processor, it transforms everything you watch into immersive 4K. Its dynamic crystal display produces a wide range of vibrant colours and crisp details. It comes preloaded with a plethora of apps and other enhancements.', 4),
(11, 'Sony,55 4K UHD HDR LED Android Smart TV (KD55X750H)', 799, 'Get all your entertainment in one place with this Sony 55 4K UHD HDR LED Smart Android TV. Its 4K Processor X1, 4K X-Reality PRO, Motionflow XR, and TRILUMINOS Display technologies combine to deliver a top-notch viewing experience. All your favourite streaming services such as Netflix, YouTube, Disney+, and Crave are available, so you won\'t miss your favourite shows.', 4),
(12, 'LG,55” 4K UHD HDR LCD webOS Smart TV (55UN7000) - 2020', 649, 'Enhance your home entertainment experience with this 55 LG UN70 Series smart TV. Backed by 4K Ultra HD resolution and a quad-core processor, this television optimises every scene in the best possible detail and delivers incredible visuals with true-to-life colours on the screen. Its webOS platform provides instant access to a world of content.', 4);
...
(4, 'pengyul', 'q15715161906@gmail.com', 'f602acbb85fed9da4f9963877a7de836', '2020-11-11 21:39:30');
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
