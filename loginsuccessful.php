<!--This page is designed as log in successfully page-->
<!--After user sucessfully log in, the website wil turn to this page-->
...
<!--In this page, user can reset password if they want-->
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<body>
		<div class="form">
			...
			<a href="new_pass.php">Reset password</a>
		</div>
	</body>
